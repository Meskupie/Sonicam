...
from webserverlink import WebServerLink
...
#web_server_link = WebServerLink('WebServerLink',queue_dict,shared_buffer_frames)
...
while True:
    ...
    try:
        if job['type'] == 'kill':
            ...
            #queue_dict['web_server'].put({'type':'full_frame','buffer_index':job['buffer_index'],'results':job['results']})
