...
class SoundStatus extends PureComponent {
    ...
    render() {
        ...
        if (this.props.isMuted) {
            indicator =
                <svg className={classes.Status} width="13px" height="16px" viewBox="0 0 13 16" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
                    <defs>
                        <linearGradient x1="96.9613989%" y1="-49.7626412%" x2="96.9613989%" y2="150.958178%" id="linearGradient-muteStatus1">
                            <stop stopColor="#FE4D4D" offset="0%"></stop>
                            <stop stopColor="#C42121" offset="100%"></stop>
                        </linearGradient>
                        <linearGradient x1="96.9613989%" y1="-86.2577271%" x2="96.9613989%" y2="181.687181%" id="linearGradient-muteStatus2">
                            <stop stopColor="#FE4D4D" offset="0%"></stop>
                            <stop stopColor="#C42121" offset="100%"></stop>
                        </linearGradient>
                    </defs>
