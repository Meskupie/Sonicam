...
const image = (props) => {
    ...
    return (
        <div style={posStyle} className={classes.Parent} onPointerDown={props.onClick} onPointerUp={props.onPointerUp} onPointerOut={props.onPointerOut} onDoubleClick={props.onDoubleClick}>
            {deleteIcon}
            {image}
        </div>
    );
