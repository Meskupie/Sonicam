...
const image = (props) => {
    ...
    return (
        <div style={posStyle} className={classes.Parent} onMouseDown={props.onClick} onMouseUp={props.onMouseUp} onMouseOut={props.onMouseOut} onDoubleClick={props.onDoubleClick}>
            {deleteIcon}
            {image}
        </div>
    );
