...
const image = (props) => {
    ...
    return (
        <div style={posStyle} className={classes.Parent} onMouseDown={props.onClick} onMouseUp={props.onMouseUp} onMouseOut={props.onMouseOut} onContextMenu={props.onDoubleClick}>
            {deleteIcon}
            {image}
        </div>
    );
