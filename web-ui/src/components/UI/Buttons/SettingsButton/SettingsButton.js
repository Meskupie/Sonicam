...
class SettingsButton extends Component {
    ...
    render() {
        ...
        return (
            <div className={classes.Settings} style={settingsButtonStyle} onClick={this.props.clicked}>
                <svg width={this.props.params.buttonSmallWidth * 42 / 80 + "px"} height={this.props.params.buttonHeight * 33 / 80 + "px"} viewBox="0 0 94 72" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
